...
export function buildBottomFeederBrief({ jobText, resumeText = "", notesText = "", topic = "role", now = new Date() }) {
  ...
  return {
    ...
    attribution: {
      workflow: "Bottom Feeder",
      credit: "Bottom Feeder is a public research workflow by clawSean.",
    },
    topic,
...
export function formatBottomFeederBriefText(brief) {
  const lines = [
    ...
    "",
    brief.attribution?.credit || "Bottom Feeder is a public research workflow by clawSean.",
    "",
